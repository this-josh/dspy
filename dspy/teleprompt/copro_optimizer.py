    ...
    def __init__(
        ...
        **_kwargs,
        ...
        if "verbose" in _kwargs:
            logger.warning("DeprecationWarning: 'verbose' has been deprecated. To see all information for debugging, use 'dspy.set_log_level('debug')'. In the future this will raise an error.")
